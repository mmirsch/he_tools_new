...
/**
 * Test case for class \HSE\HeTools\Domain\Model\Faculties.
 *
 * @copyright Copyright belongs to the respective authors
 * @license http://www.gnu.org/licenses/gpl.html GNU General Public License, version 3 or later
 *
 */
class FacultiesTest extends \TYPO3\CMS\Core\Tests\UnitTestCase
{
	/**
	...
	{
		$this->subject = new \HSE\HeTools\Domain\Model\Faculties();
	}
